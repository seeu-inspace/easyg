...
if ARGV[1] == "assetenum"
	...
	system "nuclei -l output/httprobed_" + ARGV[0] + " -t %USERPROFILE%/nuclei-templates/takeovers -t %USERPROFILE%/nuclei-templates/exposures/configs/git-config.yaml -t %USERPROFILE%\nuclei-templates\vulnerabilities\generic\crlf-injection.yaml -t %USERPROFILE%\nuclei-templates\exposures\apis\swagger-api.yaml -o output/nuclei_" + ARGV[0]
